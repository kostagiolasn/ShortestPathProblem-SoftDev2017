...
${OBJECTDIR}/BufferNode.o: BufferNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BufferNode.o BufferNode.cpp
...
${OBJECTDIR}/ComponentCursor.o: ComponentCursor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ComponentCursor.o ComponentCursor.cpp
...
${OBJECTDIR}/IndexNode.o: IndexNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IndexNode.o IndexNode.cpp
...
${OBJECTDIR}/bucket.o: bucket.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bucket.o bucket.cpp
...
${OBJECTDIR}/graphLibrary.o: graphLibrary.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphLibrary.o graphLibrary.cpp
...
${OBJECTDIR}/scc.o: scc.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/scc.o scc.cpp
...
${OBJECTDIR}/updateIndex.o: updateIndex.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/updateIndex.o updateIndex.cpp
...
${TESTDIR}/tests/tinyGraphBFSTest.o: tests/tinyGraphBFSTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/tinyGraphBFSTest.o tests/tinyGraphBFSTest.cpp
...
${OBJECTDIR}/Buffer_nomain.o: ${OBJECTDIR}/Buffer.o Buffer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Buffer_nomain.o Buffer.cpp;\
	else  \
...
${OBJECTDIR}/BufferNode_nomain.o: ${OBJECTDIR}/BufferNode.o BufferNode.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BufferNode_nomain.o BufferNode.cpp;\
	else  \
...
${OBJECTDIR}/Component_nomain.o: ${OBJECTDIR}/Component.o Component.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Component_nomain.o Component.cpp;\
	else  \
...
${OBJECTDIR}/ComponentCursor_nomain.o: ${OBJECTDIR}/ComponentCursor.o ComponentCursor.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ComponentCursor_nomain.o ComponentCursor.cpp;\
	else  \
...
${OBJECTDIR}/Index_nomain.o: ${OBJECTDIR}/Index.o Index.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Index_nomain.o Index.cpp;\
	else  \
...
${OBJECTDIR}/IndexNode_nomain.o: ${OBJECTDIR}/IndexNode.o IndexNode.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IndexNode_nomain.o IndexNode.cpp;\
	else  \
...
${OBJECTDIR}/bfs_nomain.o: ${OBJECTDIR}/bfs.o bfs.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bfs_nomain.o bfs.cpp;\
	else  \
...
${OBJECTDIR}/bucket_nomain.o: ${OBJECTDIR}/bucket.o bucket.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bucket_nomain.o bucket.cpp;\
	else  \
...
${OBJECTDIR}/graphLibrary_nomain.o: ${OBJECTDIR}/graphLibrary.o graphLibrary.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphLibrary_nomain.o graphLibrary.cpp;\
	else  \
...
${OBJECTDIR}/queue_nomain.o: ${OBJECTDIR}/queue.o queue.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/queue_nomain.o queue.cpp;\
	else  \
...
${OBJECTDIR}/scc_nomain.o: ${OBJECTDIR}/scc.o scc.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/scc_nomain.o scc.cpp;\
	else  \
...
${OBJECTDIR}/stack_nomain.o: ${OBJECTDIR}/stack.o stack.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stack_nomain.o stack.cpp;\
	else  \
...
${OBJECTDIR}/updateIndex_nomain.o: ${OBJECTDIR}/updateIndex.o updateIndex.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/updateIndex_nomain.o updateIndex.cpp;\
	else  \
