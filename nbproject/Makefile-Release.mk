...
=======
${OBJECTDIR}/index.o: index.cpp 
>>>>>>> ee4377234d641f4d97630452db8e8aadc9be6d5e
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
...
${OBJECTDIR}/nodeIndex_nomain.o: ${OBJECTDIR}/nodeIndex.o nodeIndex.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nodeIndex_nomain.o nodeIndex.cpp;\
	else  \
...
${OBJECTDIR}/nodeList_nomain.o: ${OBJECTDIR}/nodeList.o nodeList.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nodeList_nomain.o nodeList.cpp;\
	else  \
