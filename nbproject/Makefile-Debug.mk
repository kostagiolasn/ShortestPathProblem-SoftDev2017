...
${TESTDIR}/TestFiles/f3: ${TESTDIR}/tests/newsimpletest3.o ${OBJECTFILES:%.o=%_nomain.o}
...
${TESTDIR}/tests/newsimpletest3.o: tests/newsimpletest3.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newsimpletest3.o tests/newsimpletest3.cpp
